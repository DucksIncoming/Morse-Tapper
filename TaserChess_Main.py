...
# Constant Variables
# Could've made everything adaptive but I do not care lol
...
# Convert the board index to the window position
...
def drawBoard(imagePath : str, position : tuple = (0, 0), scale : tuple = (0, 0)):
...
class Piece(pygame.sprite.Sprite):
    def __init__(self, pieceType):
        ...
        # Python switch statements suck my dick
        if (pieceStyle == "standard"):
            self.image = pygame.image.load(pieces_standard.get(pieceType))

        elif (pieceStyle == "silhouette"):
            self.image = pygame.image.load(pieces_silhouette.get(pieceType))

        elif (pieceStyle == "artistic"):
            self.image = pygame.image.load(pieces_artistic.get(pieceType))

        else:
            self.image = pygame.image.load(pieces_realistic.get(pieceType))

        self.rect = self.image.get_rect()

    def drawPiece(self, position : tuple = (0, 0), scale : tuple = (0, 0)):
...
def initialFenDraw(): # Just to test the drawPiece and indexPosition functions
    Piece.drawPiece(pieces_standard.get("b_rook"), indexPosition(0), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_knight"), indexPosition(1), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_bishop"), indexPosition(2), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_queen"), indexPosition(3), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_king"), indexPosition(4), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_bishop"), indexPosition(5), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_knight"), indexPosition(6), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_rook"), indexPosition(7), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_pawn"), indexPosition(8), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_pawn"), indexPosition(9), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_pawn"), indexPosition(10), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_pawn"), indexPosition(11), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_pawn"), indexPosition(12), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_pawn"), indexPosition(13), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_pawn"), indexPosition(14), (100, 100))
    Piece.drawPiece(pieces_standard.get("b_pawn"), indexPosition(15), (100, 100))

    Piece.drawPiece(pieces_standard.get("w_pawn"), indexPosition(48), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_pawn"), indexPosition(49), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_pawn"), indexPosition(50), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_pawn"), indexPosition(51), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_pawn"), indexPosition(52), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_pawn"), indexPosition(53), (100, 100))    
    Piece.drawPiece(pieces_standard.get("w_pawn"), indexPosition(54), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_pawn"), indexPosition(55), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_rook"), indexPosition(56), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_knight"), indexPosition(57), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_bishop"), indexPosition(58), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_queen"), indexPosition(59), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_king"), indexPosition(60), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_bishop"), indexPosition(61), (100, 100))
    Piece.drawPiece(pieces_standard.get("w_knight"), indexPosition(62), (100, 100)),
    Piece.drawPiece(pieces_standard.get("w_rook"), indexPosition(63), (100, 100))

def drawWindow():
    WIN.fill(GRAY)
    drawBoard(boards.get(boardStyle), BOARD_ORIGIN)
    initialFenDraw()
...
def main():
    ...
    while run:
        ...
        if (not currentlyHolding and mouseDown[0]): # On first mouse click (this is dumb)
            print("yoink!") # I will not remove this
            currentlyHolding = True

            mousePos = pygame.mouse.get_pos()
        else:
            currentlyHolding = mouseDown[0]
